...
const Media = () => {
    ...
    return (
        <div className=''>
            ...
            {
                posts?.map(post => <div className="rounded-md my-4 shadow-lg border w-full  ">
                ...
                {post?.img && <img src={post?.img} alt="" className="object-cover object-center w-full h-72 bg-gray-500" />}
                <div className="p-3">
